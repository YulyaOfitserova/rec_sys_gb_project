...
class MainRecommender:
    ...
    def get_similar_items_recommendation(self, user, N=5):
        ...
        popular_purchases = self.top_purchases[self.top_purchases['user_id'] == user].head(N)
        res = popular_purchases['item_id'] \
            .apply(lambda x: self._get_similar_item(x)).tolist()
